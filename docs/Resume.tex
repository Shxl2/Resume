...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item In a team of two, developed a program for SLAM in Java using April tags as landmarks, which ran on an external coprocessor (Beelink mini pc).
                \item Developed a program to time-sync vision measurements.
            \end{highlights}
        \end{onecolentry}
    ...
    %     \begin{onecolentry}
    %         \textbf{} National Merit Finalist
    %     \end{onecolentry}
        
    %     \begin{onecolentry}
    %         \textbf{} FIRST Robotics Competition Dean’s List Semifinalist 2023 
    %     \end{onecolentry}
